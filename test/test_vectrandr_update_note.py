...
class UpdateNoteAction(unittest.TestCase):
    ...
    def test_update_note_pass(self, mock_patch):
        ...
        mock_patch.return_value.json.return_value = vectrandr_responses.UPDATE_NOTE_RESP
    ...
    def test_update_note_notexist_note_id(self, mock_patch):
        ...
        mock_patch.return_value.headers = vectrandr_config.DEFAULT_HEADERS
        mock_patch.return_value.json.return_value = vectrandr_responses.NOT_EXISTS_RESP
