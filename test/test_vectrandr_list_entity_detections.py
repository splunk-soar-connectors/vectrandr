...
class ListEntityDetectionsAction(unittest.TestCase):
    ...
    def test_list_entity_detections_pass(self, mock_get):
        ...
        mock_get.return_value.json.return_value = vectrandr_responses.GET_DETECTION_SEARCH_RESP
    ...
    def test_list_entity_detections_entity_id_notexist(self, mock_get):
        ...
        mock_get.return_value.status_code = 200
        mock_get.return_value.headers = vectrandr_config.DEFAULT_HEADERS
        mock_get.return_value.json.return_value = vectrandr_responses.SEARCH_NON_EXIST_ENTITY
